...
const addSortedFieldFormulaConfig = (
	config: SteedosFieldFormulaTypeConfig,
	sourceConfigs: Array<SteedosFieldFormulaTypeConfig>,
	sortedConfigs: Array<SteedosFieldFormulaTypeConfig>
) => {
...
export const getFormulaVarPathsAggregateLookups = (paths: Array<SteedosFormulaVarPathTypeConfig>) => {
	...
	let lookups = [],
		currentPath: SteedosFormulaVarPathTypeConfig,
		nextPath: SteedosFormulaVarPathTypeConfig;
	let tempLookupAs: string = "",
		tempLookupLocalField: string = "";
