...
class App extends Basic {
	...
	private readonly tableName = "原料库SAP单据";
	private readonly Collection = "hk_mater_doc__c";

	private readonly Doc = "hk_mater_doc__c";
	private readonly Doc_detail = "hk_mater_doc_detail__c";
