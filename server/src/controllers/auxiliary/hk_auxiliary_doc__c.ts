...
class App extends Basic {
	...
	private readonly tableName = "辅料库SAP单据";
	private readonly Collection = "hk_auxiliary_doc__c";

	private readonly Doc = "hk_auxiliary_doc__c";
	private readonly Doc_detail = "hk_auxiliary_doc_detail__c";
