...
import Controllers from "../../../controllers/product/product_config/hk_freezing_assign_col__c";
// import Controllers from "../../controllers/product_config/product_freezing_assign_col";
