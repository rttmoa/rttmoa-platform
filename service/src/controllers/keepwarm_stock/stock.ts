...
// src\views\keepwarm_config\distribute_col
...
class App extends Basic {
	...
	private readonly tableName = '保温库货架';
	private readonly Collection = 'kd_keepwarm_stock__c';
	...
	private FieldSchema: FieldSchema = {
		...
		shelf_status__c: {
			...
			editable: true,
			options: [
				{ label: '空闲', value: '空闲', color: '#99ff99' },
				{ label: '预占用', value: '预占用', color: '#ffb7dd' },
				{ label: '待出库', value: '待出库', color: '#fffebb' },
				{ label: '占用', value: '占用', color: '#ffa489' },
				{ label: '禁用', value: '禁用', color: '#aaaaaa' },
			],
		},
		...
		batch__c: { label: '批次', type: 'string', query: true, editable: true },
