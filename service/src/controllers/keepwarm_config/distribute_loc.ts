...
class App extends Basic {
	...
	private readonly tableName = '保温库货位分配规则（滞后）';
	private readonly Collection = 'kd_keepwarm_distribution__c';
	...
	private FieldSchema: FieldSchema = {
		...
		target_lay__c: { label: '目标层', type: 'number', query: true, editable: true, int: true },
		start_row__c: { label: '起始排', type: 'number', query: true, editable: true, int: true },
		target_row__c: { label: '目标排', type: 'number', query: true, editable: true, int: true },
