import{r as s,j as e,C as g,T as A,bF as v,bG as w,bH as n,bI as l}from"./.pnpm-e6eae8df.js";const I=`MIIBIjANBgkqhkiG9w0BAQEFAAOCAQ8AMIIBCgKCAQEA0BDRgoeZCRRvH/QLbGhe
...
lwIDAQAB`,C=`MIIEvgIBADANBgkqhkiG9w0BAQEFAASCBKgwggSkAgEAAoIBAQDQENGCh5kJFG8f
...
v4U73TKOI+a1xxr6ZMQ4vzwt`,i=`大型语言模型（LLM）是基于大量数据进行预训练的超大型深度学习模型。底层转换器是一组神经网络，这些神经网络由具有自注意力功能的编码器和解码器组成。编码器和解码器从一系列文本中提取含义，并理解其中的单词和短语之间的关系。
...
借助转换器神经网络架构，您可使用非常大规模的模型，其中通常具有数千亿个参数。这种大规模模型可以摄取通常来自互联网的大量数据，但也可以从包含 500 多亿个网页的 Common Crawl 和拥有约 5700 万个页面的 Wikipedia 等来源摄取数据。`,p="基于转换器的大型神经网络可以有数十亿个参数。模型的大小通常由模型大小、参数数量和训练数据规模之间的经验关系决定。",M=()=>{const[o,E]=s.useState(""),[a,h]=s.useState(""),[d,R]=s.useState(""),[x,y]=s.useState(""),[S,j]=s.useState(""),[B,D]=s.useState(""),[b,m]=s.useState("");return s.useEffect(()=>{function J(){h(w.lib.WordArray.random(32).toString());const t=n.AES.encrypt(i,a).toString();E(i),R(t);const r=n.AES.decrypt(t,a).toString(n.enc.Utf8);y(r)}J();function K(){const t=new l;t.setPrivateKey(I);const r=t.encrypt(p);j(p),D(r);const c=new l;c.setPrivateKey(C);const Q=c.decrypt(r);m(Q)}K()},[]),e.jsx(e.Fragment,{children:e.jsx(g,{children:e.jsxs("section",{style:{wordBreak:"break-all"},children:[e.jsx(A.Title,{level:4,className:"mb10",children:"AES加密解密"}),e.jsxs("h4",{children:[e.jsx("b",{children:"AES加密明文："}),e.jsx("span",{children:o})]}),e.jsxs("h4",{children:[e.jsx("b",{children:"AES加密密钥："}),e.jsx("span",{children:a})]}),e.jsxs("h4",{children:[e.jsx("b",{children:"AES加密密文："}),d]}),e.jsxs("h4",{children:[e.jsx("b",{children:"AES解密文件："}),x]}),e.jsx(v.Divider,{}),e.jsx(A.Title,{level:4,className:"mb10",children:"REA加密解密"}),e.jsxs("h4",{children:[e.jsx("b",{children:"REA加密明文："}),S]}),e.jsxs("h4",{children:[e.jsx("b",{children:"REA加密密文："}),B]}),e.jsxs("h4",{children:[e.jsx("b",{children:"REA解密文件："}),b]})]})})})};export{M as default};
