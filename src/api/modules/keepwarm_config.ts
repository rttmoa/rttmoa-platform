...
export class keepwarm_config_distribute_lay_API {
	private static api = '/keepwarm/config/distributeLay';
...
export class keepwarm_config_distribute_loc_API {
	private static api = '/keepwarm/config/distributeLoc';
...
export class keepwarm_config_distribute_col_API {
	private static api = '/keepwarm/config/distributeCol';
