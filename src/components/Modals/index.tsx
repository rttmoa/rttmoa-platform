...
//         const isImg =
//           file.type === "image/jpeg" || file.type === "image/bmp" || file.type === "image/gif" || file.type === "image/png";
...
//           if (initialValue.length === 1 && this.state.fileList && this.state.fileList.length === 0 && !this.state.showIcon)
//             showAdd = true;
