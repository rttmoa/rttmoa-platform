...
import { keepwarm_doc_bind_his_API } from '@/api/modules/keepwarm_doc';

const useProTable = () => {
	const api = {
		find: keepwarm_doc_bind_his_API.find,
		add: keepwarm_doc_bind_his_API.add,
		modify: keepwarm_doc_bind_his_API.mod,
		del: keepwarm_doc_bind_his_API.del,
		delMore: keepwarm_doc_bind_his_API.delMore,
		importEx: keepwarm_doc_bind_his_API.importEx,
	};
