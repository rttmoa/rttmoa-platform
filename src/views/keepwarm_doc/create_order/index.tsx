...
import { keepwarm_doc_create_API } from '@/api/modules/keepwarm_doc';

const useProTable = () => {
	const api = {
		find: keepwarm_doc_create_API.find,
		add: keepwarm_doc_create_API.add,
		modify: keepwarm_doc_create_API.mod,
		del: keepwarm_doc_create_API.del,
		delMore: keepwarm_doc_create_API.delMore,
		importEx: keepwarm_doc_create_API.importEx,
	};
