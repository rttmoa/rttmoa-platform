...
const useProTable = () => {
	const api = {
		find: hk_main_warehouse__c_API.find,
		add: hk_main_warehouse__c_API.add,
		modify: hk_main_warehouse__c_API.mod,
		del: hk_main_warehouse__c_API.del,
		delMore: hk_main_warehouse__c_API.delMore,
		importEx: hk_main_warehouse__c_API.importEx,
	};
