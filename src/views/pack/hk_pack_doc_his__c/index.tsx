...
import { hk_pack_doc_his__c_API } from '@/api/modules/pack';

const useProTable = () => {
	const api = {
		find: hk_pack_doc_his__c_API.find,
		add: hk_pack_doc_his__c_API.add,
		modify: hk_pack_doc_his__c_API.mod,
		del: hk_pack_doc_his__c_API.del,
		delMore: hk_pack_doc_his__c_API.delMore,
		importEx: hk_pack_doc_his__c_API.importEx,
	};
