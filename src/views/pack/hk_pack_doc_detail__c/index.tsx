...
const useProTable = () => {
	const api = {
		find: hk_pack_doc_detail__c_API.find,
		add: hk_pack_doc_detail__c_API.add,
		modify: hk_pack_doc_detail__c_API.mod,
		del: hk_pack_doc_detail__c_API.del,
		delMore: hk_pack_doc_detail__c_API.delMore,
		importEx: hk_pack_doc_detail__c_API.importEx,
	};
