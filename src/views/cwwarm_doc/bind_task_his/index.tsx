...
import { cwwarm_doc_bind_his_API } from '@/api/modules/cwwarm_doc';

const useProTable = () => {
	const api = {
		find: cwwarm_doc_bind_his_API.find,
		add: cwwarm_doc_bind_his_API.add,
		modify: cwwarm_doc_bind_his_API.mod,
		del: cwwarm_doc_bind_his_API.del,
		delMore: cwwarm_doc_bind_his_API.delMore,
		importEx: cwwarm_doc_bind_his_API.importEx,
	};
