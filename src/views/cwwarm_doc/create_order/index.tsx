...
import { cwwarm_doc_create_API } from '@/api/modules/cwwarm_doc';

const useProTable = () => {
	const api = {
		find: cwwarm_doc_create_API.find,
		add: cwwarm_doc_create_API.add,
		modify: cwwarm_doc_create_API.mod,
		del: cwwarm_doc_create_API.del,
		delMore: cwwarm_doc_create_API.delMore,
		importEx: cwwarm_doc_create_API.importEx,
	};
