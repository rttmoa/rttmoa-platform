...
import { hk_mater_lei_pda_out_his__c_API } from '@/api/modules/mater_general';

const useProTable = () => {
	const api = {
		find: hk_mater_lei_pda_out_his__c_API.find,
		add: hk_mater_lei_pda_out_his__c_API.add,
		modify: hk_mater_lei_pda_out_his__c_API.mod,
		del: hk_mater_lei_pda_out_his__c_API.del,
		delMore: hk_mater_lei_pda_out_his__c_API.delMore,
		importEx: hk_mater_lei_pda_out_his__c_API.importEx,
	};
