...
import { hk_interface_sap_wms__c_API } from '@/api/modules/global_wms';

const useProTable = () => {
	const api = {
		find: hk_interface_sap_wms__c_API.find,
		add: hk_interface_sap_wms__c_API.add,
		modify: hk_interface_sap_wms__c_API.mod,
		del: hk_interface_sap_wms__c_API.del,
		delMore: hk_interface_sap_wms__c_API.delMore,
		importEx: hk_interface_sap_wms__c_API.importEx,
	};
