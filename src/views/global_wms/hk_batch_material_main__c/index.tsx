...
import { hk_batch_material_main__c_API } from '@/api/modules/global_wms';

const useProTable = () => {
	const api = {
		find: hk_batch_material_main__c_API.find,
		add: hk_batch_material_main__c_API.add,
		modify: hk_batch_material_main__c_API.mod,
		del: hk_batch_material_main__c_API.del,
		delMore: hk_batch_material_main__c_API.delMore,
		importEx: hk_batch_material_main__c_API.importEx,
	};
