...
import { hk_auxiliary_stock_detail_his__c_API } from '@/api/modules/auxiliary';

const useProTable = () => {
	const api = {
		find: hk_auxiliary_stock_detail_his__c_API.find,
		add: hk_auxiliary_stock_detail_his__c_API.add,
		modify: hk_auxiliary_stock_detail_his__c_API.mod,
		del: hk_auxiliary_stock_detail_his__c_API.del,
		delMore: hk_auxiliary_stock_detail_his__c_API.delMore,
		importEx: hk_auxiliary_stock_detail_his__c_API.importEx,
	};
