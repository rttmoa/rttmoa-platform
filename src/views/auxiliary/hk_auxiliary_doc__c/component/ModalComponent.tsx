...
const ModalComponent = (Params: any) => {
	...
	const columns = useMemo(() => {
		...
		const purchaseColumns = [
			...
			{ title: '采购组织', dataIndex: 'Ekorg', key: 'Ekorg', width: 110 },
			{ title: '备案名称', dataIndex: 'BeianName', key: 'BeianName', width: 110 },
			{ title: '备案编号', dataIndex: 'BeianNo', key: 'BeianNo', width: 110 },
			{ title: '二线报关单号', dataIndex: 'DanhaoBg', key: 'DanhaoBg', width: 110 },
			{ title: '一线报关单号', dataIndex: 'DanhaoBg1', key: 'DanhaoBg1', width: 110 },
			{ title: '报关合同号', dataIndex: 'BaoguanHth', key: 'BaoguanHth', width: 110 },
		];
	...
	return (
		...
		>
			{modalType === 'create' ? createContent : formSchemaField.map((item: any) => renderFormItem(item))}
		</ModalForm>
	);
};
