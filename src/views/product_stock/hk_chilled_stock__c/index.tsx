...
import { product_chilled_stock_API } from '@/api/modules/product_task';

const useProTable = () => {
	const api = {
		find: product_chilled_stock_API.find,
		add: product_chilled_stock_API.add,
		modify: product_chilled_stock_API.mod,
		del: product_chilled_stock_API.del,
		delMore: product_chilled_stock_API.delMore,
		importEx: product_chilled_stock_API.importEx,
	};
