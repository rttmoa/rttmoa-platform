...
import { hk_chilled_stock_detail_his__c_API } from '@/api/modules/product_task';

const useProTable = () => {
	const api = {
		find: hk_chilled_stock_detail_his__c_API.find,
		add: hk_chilled_stock_detail_his__c_API.add,
		modify: hk_chilled_stock_detail_his__c_API.mod,
		del: hk_chilled_stock_detail_his__c_API.del,
		delMore: hk_chilled_stock_detail_his__c_API.delMore,
		importEx: hk_chilled_stock_detail_his__c_API.importEx,
	};
