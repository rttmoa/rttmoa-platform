...
import { product_freezing_stock_detail_barcode_API } from '@/api/modules/product_task';

const footerSummaryItems = [{ label: '汇总总重量', field: 'weight__c' }];

const useProTable = () => {
	const api = {
		find: product_freezing_stock_detail_barcode_API.find,
		add: product_freezing_stock_detail_barcode_API.add,
		modify: product_freezing_stock_detail_barcode_API.mod,
		del: product_freezing_stock_detail_barcode_API.del,
		delMore: product_freezing_stock_detail_barcode_API.delMore,
		importEx: product_freezing_stock_detail_barcode_API.importEx,
	};
