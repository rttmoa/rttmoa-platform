...
import { product_freezing_stock_API } from '@/api/modules/product_task';

const useProTable = () => {
	const api = {
		find: product_freezing_stock_API.find,
		add: product_freezing_stock_API.add,
		modify: product_freezing_stock_API.mod,
		del: product_freezing_stock_API.del,
		delMore: product_freezing_stock_API.delMore,
		importEx: product_freezing_stock_API.importEx,
	};
