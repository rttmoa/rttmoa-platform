		...
		series: [
			{
				...
				type: 'line',
				stack: 'Total',
				data: [120, 132, 101, 69, 90, 230, 210],
			},
			{
				name: 'Union Ads',
				type: 'line',
...
export const option4Fn = (): ECOption => {
	// https://echarts.apache.org/examples/zh/editor.html?c=radar2&lang=ts
	return {
		// title: {
...
// 人体水分
export const option7Fn = (): ECOption => {
	const bodyMax = 150
	...
	series: [
		{
			...
			// link是连接 - source是data的索引，target是data的索引 value是关系
			links: [
				{
					source: 0,
					target: 1,
...
// 城市车辆
export const option9Fn = (): ECOption => {
	const pathSymbols = {
		reindeer:
