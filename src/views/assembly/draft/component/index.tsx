	...
	return (
		<>
			<div style={{ border: '1px solid #ccc', zIndex: 100 }}>
				...
				<Editor defaultConfig={editorConfig} value={html} onCreated={setEditor} onChange={(editor: IDomEditor) => setHtml(editor.getHtml())} mode='default' style={{ height: '500px', overflowY: 'hidden' }} />
			</div>
			<pre>{html}</pre>
		</>
	);
