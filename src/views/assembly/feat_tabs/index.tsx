...
import { ReloadOutlined, ExpandOutlined, CompressOutlined, CloseCircleOutlined, ColumnWidthOutlined, SwitcherOutlined, VerticalLeftOutlined, VerticalRightOutlined, SmileOutlined } from '@ant-design/icons';
		...
		<React.Fragment>
			...
			<Card className='mb-[15px]'>
				...
				<Space className='text'>
					...
					<Button type='primary' icon={maximize ? <CompressOutlined /> : <ExpandOutlined />} onClick={() => dispatch(setGlobalState({ key: 'maximize', value: !maximize }))}>
						当前页全屏切换
					</Button>
