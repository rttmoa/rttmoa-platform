...
class Markdown extends React.Component<any, any> {
	...
	insertLink() {
		this.setState(
			{
				linkMask: false,
				// link: this.refs.link.value // FIXME:
			},
			() => {
...
\`\`\``
	...
	// 设置光标位置
	setCursorPosition(dom: any, val: string | any[], posLen: number | undefined) {
	...
	// 光标所在位置插入字符
	insertAtCursor(dom: any, val: string | any[]) {
		let document: any
		let sel: any
		if (document.selection) {
			...
			let startPos = Number(dom.selectionStart)
	...
	renderHtml() {
		this.setState(
			{
				html: marked(this.state.val), // FIXME:
			},
			() => {
		...
		return (
			<div id="markdowm">
				<div className="md-title">
					<ul className="cf" style={{ display: 'flex', alignItems: 'center', fontWeight: 600 }}>
						<li
							onClick={e => {
								this.setCursorPosition(this.refs.text, '****', 2)
							}}>
							<a href="javascript:;" title="粗体">
								<IconSvg iconName="bold" />
							</a>
						</li>
						<li
							onClick={e => {
							...
							<a href="javascript:;" title="斜体">
								<IconSvg iconName="italic" />
							</a>
						</li>
						<li
							onClick={e => {
						...
						<li
							...
							<a href="javascript:;" title="中划线">
								<IconSvg iconName="strikethrough" />
							</a>
						</li>
						...
						<li
							...
							<a href="javascript:;" title="引用">
								<IconSvg iconName="quote" />
							</a>
						</li>
						<li>
							<a href="javascript:;" title="图片">
								<IconSvg iconName="image" />
							</a>
						...
						<li
							...
							<a href="javascript:;" title="链接">
								<IconSvg iconName="link" />
							</a>
						</li>
						<li onClick={this.insertCode.bind(this)}>
							<a href="javascript:;" title="代码块">
								<IconSvg iconName="code" />
							</a>
						</li>
						<li
							onClick={e => {
							...
							<a href="javascript:;" title="分割线">
								<IconSvg iconName="758bianjiqi_fengexian" />
							</a>
						</li>
					</ul>
				</div>
