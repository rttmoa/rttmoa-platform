...
import { product_task_task_API } from '@/api/modules/product_task';

const useProTable = () => {
	const api = {
		find: product_task_task_API.find,
		add: product_task_task_API.add,
		modify: product_task_task_API.mod,
		del: product_task_task_API.del,
		delMore: product_task_task_API.delMore,
		importEx: product_task_task_API.importEx,
	};
