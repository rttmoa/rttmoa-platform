...
import { DownOutlined, MinusCircleTwoTone, PlusCircleTwoTone, RightOutlined } from '@ant-design/icons';
				...
				<Table
					...
					expandable={{
						...
						expandIcon: ({ expanded, onExpand, record }) => {
							if (record.children) {
								return expanded ? (
									<DownOutlined className='text-xs mr-2 text-slate-500' onClick={e => onExpand(record, e)} />
								) : (
									<RightOutlined className='text-xs mr-2 text-slate-500' onClick={e => onExpand(record, e)} />
								);
							}
							return null;
						},
