...
import { cwwarm_task_sc_task_API } from '@/api/modules/cwwarm_task';

const useProTable = () => {
	const api = {
		find: cwwarm_task_sc_task_API.find,
		add: cwwarm_task_sc_task_API.add,
		modify: cwwarm_task_sc_task_API.mod,
		del: cwwarm_task_sc_task_API.del,
		delMore: cwwarm_task_sc_task_API.delMore,
		importEx: cwwarm_task_sc_task_API.importEx,
	};
