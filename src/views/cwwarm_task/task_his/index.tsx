...
import { cwwarm_task_task_his_API } from '@/api/modules/cwwarm_task';

const useProTable = () => {
	const api = {
		find: cwwarm_task_task_his_API.find,
		add: cwwarm_task_task_his_API.add,
		modify: cwwarm_task_task_his_API.mod,
		del: cwwarm_task_task_his_API.del,
		delMore: cwwarm_task_task_his_API.delMore,
		importEx: cwwarm_task_task_his_API.importEx,
	};
