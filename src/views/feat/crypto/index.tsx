    ...
    <>
      <Card>
        <section style={{wordBreak:'break-all'}}>
          <h4><b>AES加密明文：</b><span>{aesData}</span></h4>
          <h4><b>AES加密密钥：</b><span>{aesKey}</span></h4>
          <h4><b>AES加密密文：</b>{aesEncryptData}</h4>
          <h4><b>AES解密文件：</b>{aesDecryptData}</h4>
          <hr /><br />
          <h4><b>REA加密明文：</b>{reaData}</h4>
          <h4><b>REA加密密文：</b>{reaEncryptData}</h4>
          <h4><b>REA解密文件：</b>{reaDecryptData}</h4>
        </section>
      </Card>
    </>
  );
