...
import { product_chilled_assign_col_API } from '@/api/modules/product_task';

const useProTable = () => {
	const api = {
		find: product_chilled_assign_col_API.find,
		add: product_chilled_assign_col_API.add,
		modify: product_chilled_assign_col_API.mod,
		del: product_chilled_assign_col_API.del,
		delMore: product_chilled_assign_col_API.delMore,
		importEx: product_chilled_assign_col_API.importEx,
	};
