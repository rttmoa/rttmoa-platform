...
import { product_freezing_assign_API } from '@/api/modules/product_task';

const useProTable = () => {
	const api = {
		find: product_freezing_assign_API.find,
		add: product_freezing_assign_API.add,
		modify: product_freezing_assign_API.mod,
		del: product_freezing_assign_API.del,
		delMore: product_freezing_assign_API.delMore,
		importEx: product_freezing_assign_API.importEx,
	};
