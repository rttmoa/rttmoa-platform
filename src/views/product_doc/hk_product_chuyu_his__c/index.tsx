...
import { hk_product_chuyu_his__c_API } from '@/api/modules/product_task';

const useProTable = () => {
	const api = {
		find: hk_product_chuyu_his__c_API.find,
		add: hk_product_chuyu_his__c_API.add,
		modify: hk_product_chuyu_his__c_API.mod,
		del: hk_product_chuyu_his__c_API.del,
		delMore: hk_product_chuyu_his__c_API.delMore,
		importEx: hk_product_chuyu_his__c_API.importEx,
	};
