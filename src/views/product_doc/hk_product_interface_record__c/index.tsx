...
import { product_interface_record_API } from '@/api/modules/product_task';

const useProTable = () => {
	const api = {
		find: product_interface_record_API.find,
		add: product_interface_record_API.add,
		modify: product_interface_record_API.mod,
		del: product_interface_record_API.del,
		delMore: product_interface_record_API.delMore,
		importEx: product_interface_record_API.importEx,
	};
