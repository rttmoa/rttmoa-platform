...
import { product_doc_API } from '@/api/modules/product_task';

const useProTable = () => {
	const api = {
		find: product_doc_API.find,
		add: product_doc_API.add,
		modify: product_doc_API.mod,
		del: product_doc_API.del,
		delMore: product_doc_API.delMore,
		importEx: product_doc_API.importEx,
		byOrderGetHTML: product_doc_API.byOrderGetHTML,
		globalWarehouseInfo: product_doc_API.globalWarehouseInfo,
		searchSapDocs: product_doc_API.searchSapDocs,
		searchSapDocument: product_doc_API.searchSapDocument,
		submitSapDocument: product_doc_API.submitSapDocument,
	};
