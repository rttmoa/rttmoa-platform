...
import { Cascader, DatePicker, Form, Input, InputNumber, Mentions, Select, TimePicker, TreeSelect } from 'antd'
				...
				<>
					<Form {...formItemLayout} style={{ maxWidth: 600 }}>
						...
						<Form.Item label="inline Form.Item" style={{ marginBottom: 0 }}>
							<Form.Item validateStatus="error" help="Please select right date" style={{ display: 'inline-block', width: 'calc(50% - 12px)' }}>
								<DatePicker />
							</Form.Item>
