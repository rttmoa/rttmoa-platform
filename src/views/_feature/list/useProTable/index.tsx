...
const useProTable = () => {
	...
	return (
		<>
			...
			/>
			{selectedRowsState?.length > 0 && <FooterComponent actionRef={actionRef} selectedRowsState={selectedRowsState} setSelectedRows={setSelectedRows} handleOperator={handleOperator} />}
			<ModalComponent
				form={form}
