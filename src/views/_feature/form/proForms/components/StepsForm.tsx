...
import { Alert, Button, Card, Descriptions, DescriptionsProps, Divider, Form, Input, InputNumber, Result, Select, Space, Steps, Typography } from 'antd';
	...
	return (
		...
		>
			...
			<Form.Item label='收款账户' className='mb0'>
				<Form.Item name='receiverMode' rules={[{ required: true, message: '请选择' }]} style={{ display: 'inline-block', width: 'calc(30% - 8px)' }}>
					<Select
						options={[
				...
				<Form.Item name='receiverAccount' rules={[{ required: true, message: '请输入收款账户' }]} style={{ display: 'inline-block', width: '70%', marginLeft: '8px' }}>
