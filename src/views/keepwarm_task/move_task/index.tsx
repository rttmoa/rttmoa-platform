...
import { keepwarm_task_move_API } from '@/api/modules/keepwarm_task';

const useProTable = () => {
	const api = {
		find: keepwarm_task_move_API.find,
		add: keepwarm_task_move_API.add,
		modify: keepwarm_task_move_API.mod,
		del: keepwarm_task_move_API.del,
		delMore: keepwarm_task_move_API.delMore,
		importEx: keepwarm_task_move_API.importEx,
	};
