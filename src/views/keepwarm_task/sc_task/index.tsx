...
import { keepwarm_task_sc_task_API } from '@/api/modules/keepwarm_task';

const useProTable = () => {
	const api = {
		find: keepwarm_task_sc_task_API.find,
		add: keepwarm_task_sc_task_API.add,
		modify: keepwarm_task_sc_task_API.mod,
		del: keepwarm_task_sc_task_API.del,
		delMore: keepwarm_task_sc_task_API.delMore,
		importEx: keepwarm_task_sc_task_API.importEx,
	};
