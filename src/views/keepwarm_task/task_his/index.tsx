...
import { keepwarm_task_task_his_API } from '@/api/modules/keepwarm_task';

const useProTable = () => {
	const api = {
		find: keepwarm_task_task_his_API.find,
		add: keepwarm_task_task_his_API.add,
		modify: keepwarm_task_task_his_API.mod,
		del: keepwarm_task_task_his_API.del,
		delMore: keepwarm_task_task_his_API.delMore,
		importEx: keepwarm_task_task_his_API.importEx,
	};
