...
import { keepwarm_stock_record_API } from '@/api/modules/keepwarm_stock';

const useProTable = () => {
	const api = {
		find: keepwarm_stock_record_API.find,
		add: keepwarm_stock_record_API.add,
		modify: keepwarm_stock_record_API.mod,
		del: keepwarm_stock_record_API.del,
		delMore: keepwarm_stock_record_API.delMore,
		importEx: keepwarm_stock_record_API.importEx,
	};
